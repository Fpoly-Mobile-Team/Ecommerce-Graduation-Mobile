export default {
  ...
  DELETE_MY_VOUCHER: 'DELETE_MY_VOUCHER',
  GET_NOTIF_ORDER: 'GET_NOTIF_ORDER',
  SEARCH_PRODUCT_SHOP: 'SEARCH_PRODUCT_SHOP',
  FILTER_PRODUCT: 'FILTER_PRODUCT',
  GET_HISTORY_ORDER: 'GET_HISTORY_ORDER',
  GET_HISTORY_ORDER_WAITING: 'GET_HISTORY_ORDER_WAITING',
  GET_HISTORY_ORDER_DELIVERING: 'GET_HISTORY_ORDER_DELIVERING',
  GET_HISTORY_ORDER_CANCEL: 'GET_HISTORY_ORDER_CANCEL',
  CANCEL_ORDER: 'CANCEL_ORDER',
  GET_PRODUCTS_BY_DISCOUNT_VALUE: 'GET_PRODUCTS_BY_DISCOUNT_VALUE',
  GET_PRODUCT_BY_KEYWORD: 'GET_PRODUCT_BY_KEYWORD',
  GET_PRODUCT_FLASH_SALE: 'GET_PRODUCT_FLASH_SALE',
  POST_READ_NOTIFICATION: 'POST_READ_NOTIFICATION ',
};
